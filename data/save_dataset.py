...
df = pd.DataFrame(rows, columns=["plant","stage","temperature","humidity","light_lux","age_days","N","P","K"])
df.to_csv("data/hydro_data.csv", index=False)
print("Saved data/hydro_data.csv")
